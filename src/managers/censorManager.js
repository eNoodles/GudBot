...
const confusables = [
    ...
    '𝚌', '𝙲', '¢', 'ᄃ', 'Ç', '₵', '匚', 'Ϛ', 'ᑕ', 'ᑢ', 'Ć', 'Č', 'ḉ', 'ĉ', '⒞', '𝑐', '𝒄', '𝖼', '𝘤', '亡', '匸', '⼖', '⼕'],
    //D
    ...
    'ᵀ', 'ⓣ', 'Շ', '𝐓', '𝗧', '𝘛', '𝙏', '𝚃', 'ㄒ', 'է', 'Ͳ', 'ȶ', 'ɬ', 'Ƭ', '†', '₮', 'ᖶ', 'Ť', '丅', 'ţ', 'ț', 'ṫ', 'ṭ', 'ṯ', 'ṱ', 'ẗ', '⒯', '丁', '㆜', '七', '㈦', '㊆', '亇', '⼷'],
    //U
    ...
    '❌', '❎', '✖️', '𝔛', '𝖃', '𝐗', '𝓧', '𝒳', '乂', '𝕏', '🅇', '🆇', 'ჯ', 'ₓ', 'ˣ', 'ⓧ', 'א', '𝗫', '𝘟', '𝙓', '𝚇', 'Ӽ', 'Ӿ', 'ﾒ', 'ẋ', 'ẍ', '⒳', '乄'],
    //Y
    ['y', 'ɣ', 'ʏ', 'γ', 'у', 'ү', 'ყ', 'ᶌ', 'ỿ', 'ℽ', 'ꭚ', 'Υ', 'ϒ', 'Ꭹ', 'Ꮍ', 'Ⲩ', 'ꓬ', '𐊲', 'ý', '🇾', '𝔶', '𝔜', '𝖞', '𝖄', '¥', '𝓎', '𝔂', '𝓨', '𝒴', '𝕪', '𝕐', 'ｙ', '🅈', '🆈', '⅄', 'ʎ', 'ʸ', 'ⓨ', 
    'ץ', '𝐲', '𝐘', '𝘆', '𝗬', 'ㄚ', '𝘺', '𝘠', '𝙮',' 𝙔', '𝚢', '𝚈', 'ฯ', 'Ɏ', 'ﾘ', 'Ӌ', 'ᖻ', 'ч', 'Ƴ', 'Ў', 'ÿ', 'ŷ', 'ȳ', 'ẏ', 'ẙ', 'ỳ', 'ỵ', 'ỷ', 'ỹ', '⒴', '𝑦', '𝒚', '𝗒', '丩', '丫'],
    //Z
...
function parseContent(content) {
    ...
    content = content.replace(
        /(<:\w{2,32}:[0-9]{17,19}>)|(https?:\/\/\w{2}\S+)|(\s+)|([*~`|]+)|([\u0021-\u0029\u002b-\u002f\u003a-\u0040\u005b-\u005f\u007b\u007d\u00a6\u00a8\u00ab\u00ac\u00af\u00b4\u00b7\u00b8\u00bb\u00bf\u02c6\u02dc\u2013\u2014\u2018\u2019\u201a\u201c\u201d\u201e\u2022\u2026\u2039\u203a\u2122]+)|([\u0300-\u036f]+)|[\u200b-\u200f\u2060-\u2064\u206a-\u206f\u17b4-\u17b5\u00ad\u034f\u061c\u180e]+/g, 
