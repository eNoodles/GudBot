...
const confusables = [
    ...
    'ằ', 'ẳ', 'ẵ', 'ǡ', 'ậ', 'ặ', 'ả', '⒜', '𝒂', '𝖺', '卂', 'Δ', '𝚫', '𝛥', '𝜟', '𝝙', '𝞓', 'ά', 'ᾴ', 'ἀ', 'ἂ', 'ᾂ', 'ἄ', 'ᾄ', 'ἆ', 'ᾆ', 'ᾀ', 'ἁ', 'ἃ', 'ᾃ', 'ἅ', 'ᾅ', 'ἇ', 'ᾇ', 'ᾁ', 'ὰ', 'ᾰ', 'ᾱ', 'ᾳ',
    'ᾶ', 'ᾷ', '𝛂', '𝛼', '𝜶', '𝝰', '𝞪'],
    //B
    ['b', 'Ƅ', 'Ꮟ', 'ᑲ', 'ᖯ', '𝐛', 'Β', 'В', 'Ᏼ', 'ᗷ', 'ℬ', 'ꓐ', 'Ꞵ', '𐊂', 'Ｂ', '🇧', 'ъ', 'ь', 'б', '8', '🅱️', '8️⃣', '𝔟', '𝔅', '𝖇', '𝕭', '𝓫', '𝓑', '𝒷', '𝐵', '𝕓', '𝔹', 'ʙ', '🄱', 'ᙠ', 'ᵇ', 'ᴮ', 'ⓑ', 
    '๒', 'Ⴆ', '𝐁', '𝗯', '𝗕', '𝘣', '𝘉', '𝙗', '𝘽', '𝚋', '𝙱', 'ɮ', 'Ᏸ', 'ც', '๖', 'ß', '฿', '乃', 'ҍ', 'ḃ', 'ḅ', 'ḇ', '⒝', '𝑏', '𝒃', '𝖻', 'ᵝ', 'ᵦ', '𝛃', '𝛽', '𝜷', '𝝱', '𝞫', 'Ϧ', 'ϭ', 'ϸ'],
    //C
    ['c', 'ϲ', 'ᴄ', 'ⅽ', 'ⲥ', 'ꮯ', '𐐽', '𝐜', 'ｃ', 'с', 'ƈ', 'ċ', 'ℂ', 'ℭ', 'ꓚ', '𐊢', '🝌', '🇨', '©️', '𝔠', '𝖈', '𝕮', '𝕔', '𝓬', '𝓒', '𝒸', '𝒞', '🄲', '🅲', 'Ɔ', 'ᶜ', 'ⓒ', '𝐂', '𝗰', '𝗖', '𝘤', '𝘊', '𝙘', '𝘾', 
    '𝚌', '𝙲', '¢', 'ᄃ', 'Ç', '₵', '匚', 'Ϛ', 'ᑕ', 'ᑢ', 'Ć', 'Č', 'ḉ', 'ĉ', '⒞', '𝑐', '𝒄', '𝖼', '𝘤', '亡', '匸', '⼖', '⼕', 'ͻ', 'ς', 'Ͼ'],
    //D
    ...
    'ᴺ', 'ⓝ', 'ภ', 'ɳ', '𝗡', '𝘕', '𝙉', '𝙽', 'Ꮑ', 'ŋ', 'ຖ', 'ñ', '₦', '几', 'ղ', 'ᑎ', 'ᘉ', 'Ň', 'ᶰ', 'ń', 'ņ', 'ŉ', 'ǹ', 'ṅ', 'ṇ', 'ṉ', 'ṋ', '⒩', '𝔶', '𝖞', '刀', '⼑', '九', '㈨', '㊈', '亣', '⼏',
    'Π', 'ή', 'ή', 'ῄ'],
    //O
    ...
    'ᴚ', 'ɹ', 'ɿ', 'ᵣ', 'ʳ', 'ᴿ', 'ⓡ', '尺', 'ɾ', '𝐑', '𝗥', '𝘙', '𝙍', '𝚁', 'Ɽ', 'ŕ', 'ŗ', 'ȑ', 'ȓ', 'ṙ', 'ṛ', 'ṝ', 'ṟ', '⒭', '卂'],
    //S
    ['s', 'ƽ', 'ѕ', 'ꜱ', 'ꮪ', '𐑈', 'ｓ', 'Տ', 'Ꮥ', 'ꓢ', '𐊖', 'ʂ', '🇸', '5', '5️⃣', '💲', '𝔰', '𝔖', '𝖘', '𝕾', 'ş', '𝓢', '𝓼', '𝓈', '𝒮', '𝕤', '𝕊', '🅂', '🆂', 'Ꙅ', 'ₛ', 'ˢ', 'ⓢ', 'ร', '𝐬', '𝐒', '𝘀', '𝗦', '𝘴', 
    '𝘚', '𝙨', '𝙎', '𝚜', '𝚂', 'ֆ', '丂', 'Ꭶ', 'Ƨ', '§', '₴', 'ᔕ', 'Ŝ', 'ś', 'ṥ', 'š', 'ṧ', 'ș', 'ṡ', 'ṣ', 'ṩ', '⒮', '𝑠', '𝒔', '𝗌', '⼰', 'ϩ'],
    //T
    ['t', '𝐭', '𝑡', '𝒕', '𝓉', '𝓽', '𝔱', '𝕥', '𝖙', '𝗍', '𝘁', '𝘵', '𝙩', '𝚝', 'Τ', 'Ꭲ', '⊤', '⟙', 'Ⲧ', 'ꓔ', '𐊗', '𐊱', '𐌕', '🇹', 'т', '𝔗', '𝕿', 'Ŧ', '𝓣', '𝒯', '𝕋', 'ｔ', 'ᴛ', '🅃', '🆃', '⊥', 'ʇ', 'ƚ', 'ₜ', 'ᵗ', 
    'ᵀ', 'ⓣ', 'Շ', '𝐓', '𝗧', '𝘛', '𝙏', '𝚃', 'ㄒ', 'է', 'Ͳ', 'ȶ', 'ɬ', 'Ƭ', '†', '₮', 'ᖶ', 'Ť', '丅', 'ţ', 'ț', 'ṫ', 'ṭ', 'ṯ', 'ṱ', 'ẗ', '⒯', '丁', '㆜', '七', '㈦', '㊆', '亇', '⼷', '𝛕', '𝜏', '𝝉', '𝞃',
    '𝞽', 'ϯ'],
    //U
    ...
    'ṳ', 'ṵ', 'ṷ', 'ụ', 'ủ', '⒰', '𝑢', '𝒖', '𝗎', '凵', '⼐', 'ΰ', 'ϋ', 'ῢ', 'ῧ', 'ὐ', 'ὺ', 'ῦ', '𝛖', '𝜐', '𝝊', '𝞄', '𝞾'],
    //V
    ['v', 'ν', 'ѵ', 'ᴠ', 'ⅴ', '∨', '⋁', 'ꮩ', 'ᐯ', 'ⴸ', 'ꓦ', '🇻', '𝔳', '𝔙', '𝖛', '𝖁', '𝕧', '𝓿', '𝓥', '𝓋', '𝒱', '𝕍', 'ｖ', '🆅', 'Λ', 'ʌ', 'ᵥ', 'ᵛ', 'ⱽ', 'ⓥ', 'ש', '𝐯', '𝐕', '𝘃', '𝗩', '𝘷', '𝘝', '𝙫', 
    '𝙑', '𝚟', '𝚅', 'Ꮙ', '۷', 'ง', '√', 'ᐺ', 'Ѷ', 'ṽ', 'ṿ', '⒱', '𝑣', '𝒗', '𝗏', '𝛖', '𝜐', '𝝊', '𝞄', '𝞾'],
    //W
    ['w', 'ɯ', 'ѡ', 'ԝ', 'ա', 'ᴡ', 'ꮃ', 'Ꮤ', 'ꓪ', '🇼', 'ш', 'щ', '𝔴', '𝔚', '𝖜', '𝖂', 'Ŵ', 'Ｗ', '𝔀', '𝓦', '𝓌', '𝒲', '𝕨', '𝕎', '🅆', '🆆', 'ʍ', 'ʷ', 'ᵂ', 'ⓦ', 'ฬ', '𝐰', '𝐖', '𝘄', '𝗪', '𝘸', 
    '𝘞', '𝙬', '𝙒', '𝚠', '𝚆', 'Ꮗ', 'ῳ', 'ຟ', 'ω', '₩', '山', 'చ', 'ᗯ', 'ᘺ', 'ẁ', 'ẃ', 'ẅ', 'ẇ', 'ẉ', 'ẘ', '⒲', '𝑤', '𝒘', '𝗐', '⼭', 'ψ', 'ώ', 'ὠ', 'ώ', 'ῴ', 'ὢ', 'ᾢ', 'ὤ', 'ᾤ', 'ᾠ', 'ὼ', 'ῲ', 'ῶ',
    'ῷ', '𝛚', '𝜔', '𝝎', '𝞈', '𝟂', '𝛙', '𝜓', '𝝍', '𝞇', '𝟁', 'ϣ'],
    //X
    ['x', '×', 'х', 'ᕁ', 'ᕽ', '᙮', 'ⅹ', '⤫', '⤬', '⨯', '𝐱', '𝑥', '𝒙', '𝓍', '𝔁', '𝔵', '𝕩', '𝖝', '𝗑', '𝘅', '𝘹', '𝙭', '𝚡', 'ｘ', 'Χ', '᙭', 'ᚷ', '╳', 'Ⲭ', 'ⵝ', 'ꓫ', 'Ꭓ', '𐊐', '𐊴', '𐌗', '𐌢', 'ҳ', '🇽', 
    '❌', '❎', '✖️', '𝔛', '𝖃', '𝐗', '𝓧', '𝒳', '乂', '𝕏', '🅇', '🆇', 'ჯ', 'ₓ', 'ˣ', 'ⓧ', 'א', '𝗫', '𝘟', '𝙓', '𝚇', 'Ӽ', 'Ӿ', 'ﾒ', 'ẋ', 'ẍ', '⒳', '乄', 'ᵡ', 'ᵪ', '𝛘', '𝜒', '𝝌', '𝞆', '𝟀'],
    //Y
    ['y', 'ɣ', 'ʏ', 'γ', 'у', 'ү', 'ყ', 'ᶌ', 'ỿ', 'ℽ', 'ꭚ', 'Υ', 'ϒ', 'Ꭹ', 'Ꮍ', 'Ⲩ', 'ꓬ', '𐊲', 'ý', '🇾', '𝔶', '𝔜', '𝖞', '𝖄', '¥', '𝓎', '𝔂', '𝓨', '𝒴', '𝕪', '𝕐', 'ｙ', '🅈', '🆈', '⅄', 'ʎ', 'ʸ', 'ⓨ', 
    'ץ', '𝐲', '𝐘', '𝘆', '𝗬', 'ㄚ', '𝘺', '𝘠', '𝙮',' 𝙔', '𝚢', '𝚈', 'ฯ', 'Ɏ', 'ﾘ', 'Ӌ', 'ᖻ', 'ч', 'Ƴ', 'Ў', 'ÿ', 'ŷ', 'ȳ', 'ẏ', 'ẙ', 'ỳ', 'ỵ', 'ỷ', 'ỹ', '⒴', '𝑦', '𝒚', '𝗒', '丩', '丫', 'Ύ', 'Ύ', 'Ϋ', 'Ὑ',
    'Ῠ', 'Ῡ', 'ϓ', 'ϔ'],
    //Z
    ['z', 'ᴢ', 'ꮓ', 'Ζ', 'ℤ', 'ꓜ', 'Ｚ', 'ʐ', 'ż', '🇿', '𝖟', '𝖅', 'ⓩ', 'ž', '𝔃', '𝓩', '𝓏', '𝒵', '𝕫', '🅉', '🆉', 'Ƹ', 'ᶻ', 'չ', 'ȥ', '𝐳', '𝐙', '𝘇', '𝗭', '𝘻', '𝘡', '𝙯', '𝙕', '𝚣', '𝚉', 'ʑ', 'Ⱬ', '乙', 
    'ɀ', 'ᘔ', 'Ƶ', 'ź', 'ẑ', 'ẓ', 'ẕ', '⒵', '𝑧', '𝒛', '𝔷', '𝗓', '之', '⼄', '㆚']
];
...
function parseContent(content) {
    ...
    let censored = content.replace(blacklist_regexp, (word, index) => {
        ...
        //if content does not start or end with word
        if (index !== 0 && end_index < content.length) {
            ...
            //if [1;2] splitters found, and neither of them are at the first or last index, then this is most likely a false positive
            //this is to avoid situations like 'what kind oF A Guy'
            if (inner_re.length && inner_re.length <= 2 && inner_re.every(e => e.lookup_idx !== index && e.lookup_idx !== end_index)) return word;
        }
