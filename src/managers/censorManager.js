...
const confusables = [
    ['a', '@', 'ɑ', 'α', 'а', '⍺', '𝐚', 'ａ', 'ạ', 'ą', 'ä', 'à', 'á', 'Ꭺ', 'ᗅ', 'ꓮ', '𐊠', '🇦', 'д', '4', '🅰️', '4️⃣', '𝔞', '𝔄', '𝖆', '𝕬', 'ค', '𝓪', '𝓐', '𝒶', '𝒜', '𝕒', '𝔸', 'ᴀ', '🄰', '∀', 'ɐ', 'ɒ', 'ₐ', 'ᵃ', 'ᴬ', 'ⓐ', '𝐀', '𝗮', '𝗔', '𝘢', '𝘈', '𝙖', '𝘼', '𝚊', '𝙰', 'ǟ', 'Ꮧ', 'å', '₳', '卂', 'ﾑ', 'Λ', 'Ⱥ', 'ᗩ', 'Ã', 'ά'],
    ['b', 'Ƅ', 'Ꮟ', 'ᑲ', 'ᖯ', '𝐛', 'Β', 'В', 'Ᏼ', 'ᗷ', 'ℬ', 'ꓐ', 'Ꞵ', '𐊂', 'Ｂ', '🇧', 'ъ', 'ь', 'б', '8', '🅱️', '8️⃣', '𝔟', '𝔅', '𝖇', '𝕭', '𝓫', '𝓑', '𝒷', '𝐵', '𝕓', '𝔹', 'ʙ', '🄱', 'ᙠ', 'ᵇ', 'ᴮ', 'ⓑ', '๒', 'Ⴆ', '𝐁', '𝗯', '𝗕', '𝘣', '𝘉', '𝙗', '𝘽', '𝚋', '𝙱', 'ɮ', 'Ᏸ', 'ც', '๖', 'ß', '฿', '乃', 'ҍ'],
    ['c', 'ϲ', 'ᴄ', 'ⅽ', 'ⲥ', 'ꮯ', '𐐽', '𝐜', 'ｃ', 'с', 'ƈ', 'ċ', 'ℂ', 'ℭ', 'ꓚ', '𐊢', '🝌', '🇨', '©️', '𝔠', '𝖈', '𝕮', '𝕔', '𝓬', '𝓒', '𝒸', '𝒞', '🄲', '🅲', 'Ɔ', 'ᶜ', 'ⓒ', '𝐂', '𝗰', '𝗖', '𝘤', '𝘊', '𝙘', '𝘾', '𝚌', '𝙲', '¢', 'ᄃ', 'Ç', '₵', '匚', 'Ϛ', 'ᑕ', 'ᑢ', 'Ć', 'Č'],
    ['d', 'Ꮷ', 'ᑯ', 'ⅆ', 'ⅾ', 'ꓒ', '𝐝', 'ԁ', 'ɗ', 'Ꭰ', 'ᗞ', 'ᗪ', 'ⅅ', 'ꓓ', '🇩', '𝔡', '𝔇', '𝖉', '𝕯', 'ｄ', '∂', '𝓭', '𝓓', '𝒹', '𝒟', '𝕕', '𝔻', '🄳', '🅳', 'ᗡ', 'ᵈ', 'ᴰ', 'ⓓ', '๔', 'ԃ', '𝐃', '𝗱', '𝗗', '𝘥', '𝘋', '𝙙', '𝘿', '𝚍', '𝙳', 'ɖ', 'Ꮄ', '໓', 'Ð', 'Đ', 'の', 'ᕲ', 'Ď'],
    ['e', 'ҽ', '℮', 'ℯ', 'ⅇ', 'ꬲ', '𝐞', 'ｅ', 'е', 'ẹ', 'ė', 'é', 'è', 'Ε', 'Ꭼ', 'ℰ', '⋿', 'ⴹ', 'ꓰ', '𐊆', '🇪', 'э', 'ё', '3', '3️⃣', '𝔢', '𝔈', '𝖊', '𝕰', '𝓮', '𝓔', '𝑒', '𝐸', '𝕖', '𝔼', 'ᴇ', '🄴', '🅴', 'ǝ', 'ɘ', 'ₑ', 'ᵉ', 'ᴱ', 'ⓔ', 'є', '𝐄', '𝗲', '乇', '𝗘', '𝘦', '𝘌', '𝙚', '𝙀', 'έ', '𝚎', '𝙴', 'ɛ', 'Ꮛ', 'ē', 'ê', '£', 'Ɇ', 'ᘿ', 'ᗱ', 'ᗴ', '€', '𝒆'],
    ['f', 'ſ', 'ք', 'ẝ', 'ꞙ', 'ꬵ', '𝐟', 'Ϝ', 'ᖴ', 'ℱ', 'ꓝ', '𐊇', '🇫', '𝔣', '𝔉', '𝖋', '𝕱', '𝕗', '𝔽', '𝓯', '𝓕', '𝒻', '𝐹', 'ｆ', 'ꜰ', '🄵', '🅵', 'Ⅎ', 'ɟ', 'ꟻ', 'Ꮈ', 'ᶠ', 'ⓕ', 'Ŧ', '𝐅', '𝗳', '𝗙', '𝘧', '𝘍', '𝙛', '𝙁', '𝚏', '𝙵', 'ʄ', 'ƒ', '₣', '千', 'ғ', '𝒇'],
    ['g', 'ƍ', 'ɡ', 'ց', 'ᶃ', 'ℊ', '𝐠', '𝑔', '𝒈', '𝓰', '𝔤', '𝕘', '𝖌', '𝗀', '𝗴', '𝘨', '𝙜', '𝚐', 'ｇ', 'ġ', 'Ԍ', 'Ꮐ', 'Ᏻ', 'ꓖ', '𝐆', '𝐺', '𝑮', '𝒢', '𝓖', '𝔊', '𝔾', '𝕲', '𝖦', '𝗚', '𝘎', '𝙂', '𝙶', '🇬', '6', '9', '6️⃣', '9️⃣', 'Ꮆ', 'ɢ', '🄶', '🅶', '⅁', 'ɓ', 'ᵍ', 'ᴳ', 'ᘜ', 'ⓖ', 'ﻮ', 'ɠ', 'ງ', '₲', 'ģ', 'Ğ', 'Ǥ'],
    ['h', 'һ', 'հ', 'Ꮒ', 'ℎ', '𝐡', '𝒉', '𝒽', '𝓱', '𝔥', '𝕙', '𝖍', '𝗁', '𝗵', '𝘩', '𝙝', '𝚑', 'ｈ', 'Η', 'Ꮋ', 'ᕼ', 'ℋ', 'ℌ', 'ℍ', 'Ⲏ', 'ꓧ', '𐋏', '𝐇', '𝐻', '𝑯', '𝓗', '𝕳', '𝖧', '𝗛', '𝘏', '𝙃', '𝙷', '𝚮', '𝛨', '𝜢', '𝝜', '𝞖', '🇭', 'н', 'ʜ', '🄷', '🅷', 'ɥ', 'ん', 'ₕ', 'ʰ', 'ᴴ', 'ⓗ', 'ђ', 'ԋ', 'ɦ', 'ɧ', 'Ή', 'Ⱨ', '卄', 'Ƕ', 'Ĥ', 'ħ'],
    ['i', 'ı', 'ɩ', 'ɪ', 'ι', 'і', 'ӏ', 'Ꭵ', 'ℹ', 'ⅈ', 'ⅰ', '⍳', 'ꙇ', '\\|', 'ǀ', '׀', 'ߊ', 'ᛁ', 'ℐ', 'ℑ', 'ℓ', '∣', 'Ⲓ', 'ⵏ', 'ꓲ', '𐊊', '𐌉', 'í', 'ï', '🇮', '1', '1️⃣', '𝔦', '𝖎', '𝕴', 'ｉ', '𝓲', '𝓘', '𝒾', '𝐼', '𝕚', '𝕀', '🄸', '🅸', 'ᵢ', 'ⁱ', 'ᴵ', 'ⓘ', 'เ', '𝐢', '𝐈', '𝗶', '𝗜', '𝘪', '𝘐', '𝙞', '𝙄', 'ﾉ', '𝚒', '𝙸', 'ɨ', 'Ì', 'ł', '丨', 'į', 'ᓰ'],
    ['j', 'ϳ', 'ј', 'ⅉ', '𝐣', '𝑗', '𝒋', '𝒿', '𝓳', '𝔧', '𝕛', '𝖏', '𝗃', '𝗷', '𝘫', '𝙟', '𝚓', 'ｊ', 'Ꭻ', 'ᒍ', 'ꓙ', 'Ʝ', '𝐉', '𝐽', '𝑱', '𝒥', '𝓙', '𝔍', '𝕁', '𝕵', '𝖩', '𝗝', '𝘑', '𝙅', '𝙹', '🇯', 'Ĵ', 'ᴊ', '🄹', '🅹', 'ɾ', 'Ⴑ', 'ꞁ', 'ⱼ', 'ʲ', 'ᴶ', 'ⓙ', 'ן', 'Ꮭ', 'ว', 'נ', 'ﾌ', 'ل', 'ᒚ', 'ᒎ', 'ڶ'],
    ['k', '𝐤', '𝑘', '𝒌', '𝓀', '𝓴', '𝕜', '𝗄', '𝗸', '𝘬', '𝙠', '𝚔', 'Κ', 'Ꮶ', 'ᛕ', 'Ⲕ', 'ꓗ', 'Ｋ', '🇰', 'к', '𝔨', '𝔎', '𝖐', '𝕶', '𝓚', '𝒦', '𝕂', 'ᴋ', '🄺', '🅺', '⋊', 'ʞ', 'ₖ', 'ᵏ', 'ᴷ', 'ⓚ', 'ƙ', '𝐊', '𝗞', '𝘒', '𝙆', '𝙺', 'ӄ', '₭', 'Ҝ', 'ҟ', 'Ҡ', 'ᖽᐸ', 'Ќ', 'ķ'],
    ['l', 'ߊ', 'ⅼ', 'Ꮮ', 'ᒪ', 'ℒ', 'Ⳑ', 'ꓡ', '𐐛', 'ḷ', '🇱', '𝔩', '𝔏', '𝖑', '𝕷', '𝓛', '𝕝', '𝓵', '𝓁', '𝐿', '𝕃', 'ｌ', 'ʟ', '🄻', '🅻', '˥', '⅃', 'ₗ', 'ˡ', 'ᴸ', 'ⓛ', 'ɭ', 'ʅ', '𝐥', '𝐋', '𝗹', '𝗟', '𝘭', '𝘓', '1', '1️⃣', '𝙡', '𝙇', '𝚕', '𝙻', 'ᄂ', 'Ⱡ', 'ㄥ', 'Ꝉ', 'Ĺ', 'Ļ'],
    ['m', 'ⅿ', 'Μ', 'Ϻ', 'Ꮇ', 'ᗰ', 'ᛖ', 'ℳ', 'Ⲙ', 'ꓟ', '𐊰', '𐌑', '𝐌', '𝑀', '𝑴', '𝓜', '𝔐', '𝕄', '𝕸', '𝖬', '𝗠', '𝘔', '𝙈', '𝙼', '𝚳', '𝛭', '𝜧', '𝝡', '🇲', 'м', 'Ⓜ️', 'Ⓜ', '𝔪', '𝖒', '𝓂', '𝓶', '𝕞', 'ｍ', 'ᴍ', '🄼', '🅼', 'ₘ', 'ᵐ', 'ᴹ', '๓', 'ɱ', '𝐦', '𝗺', '𝘮', '𝙢', '𝚖', 'ʍ', 'ﾶ', '爪', 'ᘻ', '₥'],
    ['n', 'ո', 'ռ', '𝐧', '𝑛', '𝒏', '𝓃', '𝓷', '𝔫', '𝕟', '𝖓', '𝗇', '𝗻', '𝘯', '𝙣', '𝚗', 'Ν', 'ℕ', 'Ⲛ', 'ꓠ', 'Ｎ', '🇳', 'п', 'л', 'и', '𝔑', '𝕹', '𝐍', '𝓝', '𝒩', 'ɴ', '🄽', '🅽', 'Ͷ', 'ᴎ', 'ₙ', 'ⁿ', 'ᴺ', 'ⓝ', 'ภ', 'ɳ', '𝗡', '𝘕', '𝙉', '𝙽', 'Ꮑ', 'ŋ', 'ຖ', 'ñ', '₦', '几', 'ղ', 'ᑎ', 'ᘉ', 'Ň', 'ᶰ'],
    ['o', 'σ', 'ס', '०', '੦', '૦', '௦', 'ం', '౦', 'ಂ', '೦', 'ം', 'ഠ', '൦', 'ං', '๐', '໐', 'ဝ', '၀', 'ჿ', '߀', '০', 'ଠ', '୦', 'ዐ', 'Ⲟ', 'ⵔ', '〇', 'ꓳ', '𐊒', '𐊫', '𐐄', '𐓂', 'о', 'ο', 'օ', 'ȯ', 'ọ', 'ỏ', 'ơ', 'ó', 'ò', 'ö', '🇴', '0', '🅾️', '⭕', '0️⃣', '𝔬', '𝔒', '𝖔', '𝕺', 'ට', 'ｏ', '𝓸', '𝓞', '𝑜', '𝒪', '𝕠', '𝕆', 'ᴏ', '🄾', 'ₒ', 'ᵒ', 'ᴼ', 'ⓞ', '๏', '𝐨', '𝐎', '𝗼', '𝗢', '𝘰', '𝘖', '𝙤', 'ㄖ', '𝙊', '𝚘', '𝙾', 'Ꭷ', 'Ꮼ', 'Ө', 'Ø', 'Ỗ'],
    ['p', '⍴', 'ⲣ', '𝐩', '𝑝', '𝒑', '𝓅', '𝓹', '𝔭', '𝕡', '𝖕', '𝗉', '𝗽', '𝘱', '𝙥', '𝚙', '𝛒', '𝜌', '𝝆', '𝞀', '𝞺', 'Ρ', 'Р', 'Ꮲ', 'ᑭ', 'ℙ', 'ꓑ', '𐊕', '𝐏', '𝑃', '𝑷', '𝒫', '𝓟', '𝖯', '𝗣', '𝘗', '𝙋', '𝙿', '𝚸', '𝛲', '𝜬', '𝝦', '𝞠', 'Ｐ', '🇵', '🅿️', '𝔓', '𝕻', 'ⓟ', 'ᴘ', '🄿', 'ꟼ', 'ₚ', 'ᵖ', 'ᴾ', 'ק', 'Ꭾ', '℘', 'þ', '₱', '卩', 'ᕵ', 'Ƥ'],
    ['q', 'ԛ', 'գ', 'զ', '𝐪', '𝑞', '𝒒', '𝓆', '𝓺', '𝔮', '𝕢', '𝖖', '𝗊', '𝗾', '𝘲', '𝙦', '𝚚', 'ℚ', 'ⵕ', '𝐐', '𝑄', '𝑸', '𝒬', '𝓠', '𝖰', '𝗤', '𝘘', '𝙌', '𝚀', '🇶', '𝔔', '𝕼', 'ｑ', 'Ǫ', '🅀', '🆀', 'Ό', 'ợ', 'ϙ', 'Ꭴ', 'Ɋ', 'Ҩ', 'ᑫ', 'ᕴ', 'Ⓠ'],
    ['r', 'г', 'ᴦ', 'ⲅ', 'ꭇ', 'ꭈ', 'ꮁ', '𝐫', '𝑟', '𝒓', '𝓇', '𝓻', '𝔯', '𝕣', '𝖗', '𝗋', '𝗿', '𝘳', '𝙧', '𝚛', 'Ʀ', 'Ꭱ', 'Ꮢ', 'ᖇ', 'ℛ', 'ℜ', 'ℝ', 'ꓣ', '𐒴', '🇷', '®️', 'я', '𝕽', 'Ř', '𝓡', '𝑅', 'ｒ', '🅁', '🆁', 'ᴚ', 'ɹ', 'ɿ', 'ᵣ', 'ʳ', 'ᴿ', 'ⓡ', '尺', 'ɾ', '𝐑', '𝗥', '𝘙', '𝙍', '𝚁', 'Ɽ', 'ŕ'],
    ['s', 'ƽ', 'ѕ', 'ꜱ', 'ꮪ', '𐑈', 'ｓ', 'Տ', 'Ꮥ', 'ꓢ', '𐊖', 'ʂ', '🇸', '5', '5️⃣', '💲', '𝔰', '𝔖', '𝖘', '𝕾', 'ş', '𝓢', '𝓼', '𝓈', '𝒮', '𝕤', '𝕊', '🅂', '🆂', 'Ꙅ', 'ₛ', 'ˢ', 'ⓢ', 'ร', '𝐬', '𝐒', '𝘀', '𝗦', '𝘴', '𝘚', '𝙨', '𝙎', '𝚜', '𝚂', 'ֆ', '丂', 'Ꭶ', 'Ƨ', '§', '₴', 'ᔕ', 'Ŝ'],
    ['t', '𝐭', '𝑡', '𝒕', '𝓉', '𝓽', '𝔱', '𝕥', '𝖙', '𝗍', '𝘁', '𝘵', '𝙩', '𝚝', 'Τ', 'Ꭲ', '⊤', '⟙', 'Ⲧ', 'ꓔ', '𐊗', '𐊱', '𐌕', '🇹', 'т', '𝔗', '𝕿', 'Ŧ', '𝓣', '𝒯', '𝕋', 'ｔ', 'ᴛ', '🅃', '🆃', '⊥', 'ʇ', 'ƚ', 'ₜ', 'ᵗ', 'ᵀ', 'ⓣ', 'Շ', '𝐓', '𝗧', '𝘛', '𝙏', '𝚃', 'ㄒ', 'է', 'Ͳ', 'ȶ', 'ɬ', 'Ƭ', '†', '₮', 'ᖶ', 'Ť', '丅', 'ţ'],
    ['u', 'ʋ', 'ᴜ', 'ꭎ', 'ꭒ', '𐓶', 'ሀ', 'ᑌ', '∪', '⋃', 'ꓴ', 'υ', 'ս', 'ü', 'ú', 'ù', '🇺', 'ц', '𝔲', '𝔘', '𝖚', '𝖀', 'Ｕ', '𝐔', '𝓾', '𝓤', '𝓊', '𝒰', '𝕦', '𝕌', '🅄', '🆄', '∩', 'ᵤ', 'ᵘ', 'ᵁ', 'ⓤ', 'ย', '𝐮', '𝘂', '𝗨', '𝘶', '𝘜', '𝙪', '𝙐', '𝚞', '𝚄', 'ʊ', 'ひ', 'ų', 'น', 'ㄩ', 'մ', 'Ʉ', 'վ', 'ᑘ', 'Ǘ'],
    ['v', 'ν', 'ѵ', 'ᴠ', 'ⅴ', '∨', '⋁', 'ꮩ', 'ᐯ', 'ⴸ', 'ꓦ', '🇻', '𝔳', '𝔙', '𝖛', '𝖁', '𝕧', '𝓿', '𝓥', '𝓋', '𝒱', '𝕍', 'ｖ', '🆅', 'Λ', 'ʌ', 'ᵥ', 'ᵛ', 'ⱽ', 'ⓥ', 'ש', '𝐯', '𝐕', '𝘃', '𝗩', '𝘷', '𝘝', '𝙫', '𝙑', '𝚟', '𝚅', 'Ꮙ', '۷', 'ง', '√', 'ᐺ', 'Ѷ'],
    ['w', 'ɯ', 'ѡ', 'ԝ', 'ա', 'ᴡ', 'ꮃ', 'Ꮤ', 'ꓪ', '🇼', 'ш', 'щ', '𝔴', '𝔚', '𝖜', '𝖂', 'Ŵ', 'Ｗ', '𝔀', '𝓦', '𝓌', '𝒲', '𝕨', '𝕎', '🅆', '🆆', 'ʍ', 'ʷ', 'ᵂ', 'ⓦ', 'ฬ', '𝐰', '𝐖', '𝘄', '𝗪', '𝘸', '𝘞', '𝙬', '𝙒', '𝚠', '𝚆', 'Ꮗ', 'ῳ', 'ຟ', 'ω', '₩', '山', 'చ', 'ᗯ', 'ᘺ'],
    ['x', '×', 'х', 'ᕁ', 'ᕽ', '᙮', 'ⅹ', '⤫', '⤬', '⨯', '𝐱', '𝑥', '𝒙', '𝓍', '𝔁', '𝔵', '𝕩', '𝖝', '𝗑', '𝘅', '𝘹', '𝙭', '𝚡', 'ｘ', 'Χ', '᙭', 'ᚷ', '╳', 'Ⲭ', 'ⵝ', 'ꓫ', 'Ꭓ', '𐊐', '𐊴', '𐌗', '𐌢', 'ҳ', '🇽', '❌', '❎', '✖️', '𝔛', '𝖃', '𝐗', '𝓧', '𝒳', '乂', '𝕏', '🅇', '🆇', 'ჯ', 'ₓ', 'ˣ', 'ⓧ', 'א', '𝗫', '𝘟', '𝙓', '𝚇', 'Ӽ', 'Ӿ', 'ﾒ'],
    ['y', 'ɣ', 'ʏ', 'γ', 'у', 'ү', 'ყ', 'ᶌ', 'ỿ', 'ℽ', 'ꭚ', 'Υ', 'ϒ', 'Ꭹ', 'Ꮍ', 'Ⲩ', 'ꓬ', '𐊲', 'ý', '🇾', '𝔶', '𝔜', '𝖞', '𝖄', '¥', '𝓎', '𝔂', '𝓨', '𝒴', '𝕪', '𝕐', 'ｙ', '🅈', '🆈', '⅄', 'ʎ', 'ʸ', 'ⓨ', 'ץ', '𝐲', '𝐘', '𝘆', '𝗬', 'ㄚ', '𝘺', '𝘠', '𝙮',' 𝙔', '𝚢', '𝚈', 'ฯ', 'Ɏ', 'ﾘ', 'Ӌ', 'ᖻ', 'ч', 'Ƴ', 'Ў'],
    ['z', 'ᴢ', 'ꮓ', 'Ζ', 'ℤ', 'ꓜ', 'Ｚ', 'ʐ', 'ż', '🇿', '𝖟', '𝖅', 'ⓩ', 'ž', '𝔃', '𝓩', '𝓏', '𝒵', '𝕫', '🅉', '🆉', 'Ƹ', 'ᶻ', 'չ', 'ȥ', '𝐳', '𝐙', '𝘇', '𝗭', '𝘻', '𝘡', '𝙯', '𝙕', '𝚣', '𝚉', 'ʑ', 'Ⱬ', '乙', 'ɀ', 'ᘔ', 'Ƶ']
];
...
function parseContent(content) {
    ...
    //custom emojis:    <:\w{2,32}:[0-9]{17,18}>
    //urls:             https?:\/\/\w{2}\S+
    //whitespace:       \s+
    //formatters:       [*~`|]+
    //special chars:    [!@#$%^&()\-_+={}\[\]\\/:;'"<>,.?…‚„ˆ‹›‘’“”•–—˜™¦¨«¬¯´·¸»¿]+
    ...
    content = content.replace(
        /(<:\w{2,32}:[0-9]{17,18}>)|(https?:\/\/\w{2}\S+)|(\s+)|([*~`|]+)|([\u0021-\u0029\u002b-\u002f\u003a-\u0040\u005b-\u005f\u007b\u007d\u00a6\u00a8\u00ab\u00ac\u00af\u00b4\u00b7\u00b8\u00bb\u00bf\u02c6\u02dc\u2013\u2014\u2018\u2019\u201a\u201c\u201d\u201e\u2022\u2026\u2039\u203a\u2122]+)|[\u200b-\u200f\u2060-\u2064\u206a-\u206f\u17b4-\u17b5\u00ad\u034f\u061c\u180e]+/g, 
    ...
    let censored = content.replace(blacklist_regexp, (word, index) => {
        ...
        const repeating_prefix = index + word.search(/^([a-z])\1+/);
        //check if word ends on repeating letter (ex: testsss)
        const repeating_suffix = index + word.search(/([a-z])\1+$/);
        ...
        if (length_diff) {
            ...
            //adjust reinsertion indexes of spaces that come after word
            reinsertions = reinsertions.map(e => {
                if (e.reinsert_idx >= end_index) e.reinsert_idx -= length_diff;
                return e;
            });
        }
