...
const confusables = [
    ...
    '𝘥', '𝘋', '𝙙', '𝘿', '𝚍', '𝙳', 'ɖ', 'Ꮄ', '໓', 'Ð', 'Đ', 'の', 'ᕲ', 'Ď'],
    //E
    ['e', 'ҽ', '℮', 'ℯ', 'ⅇ', 'ꬲ', '𝐞', 'ｅ', 'е', 'ẹ', 'ė', 'é', 'è', 'Ε', 'Ꭼ', 'ℰ', '⋿', 'ⴹ', 'ꓰ', '𐊆', '🇪', 'э', 'ё', '3', '3️⃣', '𝔢', '𝔈', '𝖊', '𝕰', '𝓮', '𝓔', '𝑒', '𝐸', '𝕖', '𝔼', 'ᴇ', '🄴', '🅴', 'ǝ', 
    'ɘ', 'ₑ', 'ᵉ', 'ᴱ', 'ⓔ', 'є', '𝐄', '𝗲', '乇', '𝗘', '𝘦', '𝘌', '𝙚', '𝙀', 'έ', '𝚎', '𝙴', 'ɛ', 'Ꮛ', 'ē', 'ê', '£', 'Ɇ', 'ᘿ', 'ᗱ', 'ᗴ', '€', '𝒆'],
    //F
